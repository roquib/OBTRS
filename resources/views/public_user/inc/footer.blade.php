      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-5">
          <div class="footer-widget">
            ...
            <p class="mt-0">Redbus is a very easy and useful resources from where you can read, order and buy specific book.</p>
        ...
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-5">
          <div class="footer-widget footer-menu">
            <h3>contacts</h3>
            <ul>
              <li>Ashkona, Airport, Dhaka, bangladesh</li>
              <li>Prembagan, Dhaka-1213</li>
              <li>+8801976-829262</li>
              <li><a style="text-transform: lowercase;" href="#">roquib01@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xs-12 mx-auto">
          <div class="copyright float-center">
            <h4>&copy; copyright 2019. All right reserved  <a href="#">Soptoborno</a></h4>
          </div>
        </div>
      </div>
    </div>
